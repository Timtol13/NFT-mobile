    ...
    const categoriesCollection = [
        <div className={'slot'}>
                <div className={'slotImage'}>
                    <img src={require('../../assets/categories/1.svg')}/>
                    <button className={'categoriesImageBtn'}><h2>Place a Bid</h2></button>
                </div>
                <div className={'slotProfile'}>
                    <div className='slotInfo'>
                        <img src={require('../../assets/categories/profilePhoto2.svg')} width={50} height={50}/>
                        <div>
                            <h2>Virtual Art</h2>
                            <h5>by @wzard</h5>
                        </div>
            ...
            <div className={'slot'}>
            <div className={'slotImage'}>
                <img src={require('../../assets/categories/2.svg')}/>
                <button className={'categoriesImageBtn'}><h2>Place a Bid</h2></button>
            </div>
            <div className={'slotProfile'}>
                <div className='slotInfo'>
        ...
        <div className={'slot'}>
        <div className={'slotImage'}>
            <img src={require('../../assets/categories/3.svg')}/>
            <button className={'categoriesImageBtn'}><h2>Place a Bid</h2></button>
        </div>
        <div className={'slotProfile'}>
            <div className='slotInfo'>
  ...
  return (
    <div className={'categories'}>
        <div className={'categoriesHead'}>
            <h1>Explore <br />By Categories</h1>
            <div className={'ball'}></div>
        </div>
        <div className={'slots'}>
            {categoriesCollection.map(el => {
                return el
            })}
